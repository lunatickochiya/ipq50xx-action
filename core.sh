...
# for 2410 ipq
	...
	[ -d $OpenWrt_PATCH_FILE_DIR/mypatch-openwrt-ipq50xx ] && mv -f $OpenWrt_PATCH_FILE_DIR/mypatch-openwrt-ipq50xx openwrt/mypatch-openwrt-ipq50xx
	[ -d $OpenWrt_PATCH_FILE_DIR/mypatch-openwrt-ipq50xx-$Matrix_Target ] && mv -f $OpenWrt_PATCH_FILE_DIR/mypatch-openwrt-ipq50xx-$Matrix_Target openwrt/mypatch
	fi
...
function fix_openwrt_feeds() {
	...
	if [ "$OpenWrt_PATCH_FILE_DIR" = "openwrt-ipq50xx" ]; then
	[ -d $OpenWrt_PATCH_FILE_DIR/lunatic7-revert ] && mv -f $OpenWrt_PATCH_FILE_DIR/lunatic7-revert openwrt/feeds/lunatic7/lunatic7-revert
	[ -d $OpenWrt_PATCH_FILE_DIR/luci-patch-openwrt-ipq50xx ] && mv -f $OpenWrt_PATCH_FILE_DIR/luci-patch-openwrt-ipq50xx openwrt/feeds/luci/luci-patch-openwrt-ipq50xx
	[ -d $OpenWrt_PATCH_FILE_DIR/feeds-package-patch-openwrt-ipq50xx ] && mv -f $OpenWrt_PATCH_FILE_DIR/feeds-package-patch-openwrt-ipq50xx openwrt/feeds/packages/feeds-package-patch-openwrt-ipq50xx
	fi
